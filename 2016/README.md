...
On the backend side, the project was written in ASP.NET Web API, C#.  
For data, we used the PostgreSQL DBMS. And the frontend was created on React.  
Technically, it was a large, complex project.
